output "azurerm_resource_group_NetworkWatcherRG_id" {
  value = "${azurerm_resource_group.NetworkWatcherRG.id}"
}

output "azurerm_resource_group_NetworkWatcherRG_name" {
...
output "azurerm_resource_group_databricks-signature-azuresql_name" {
  value = "${azurerm_resource_group.databricks-signature-azuresql.name}"
}

output "azurerm_resource_group_databricks-signature_id" {
  value = "${azurerm_resource_group.databricks-signature.id}"
}

output "azurerm_resource_group_databricks-signature_name" {
...
output "azurerm_resource_group_rg-zscaler-zpa-connector_id" {
  value = "${azurerm_resource_group.rg-zscaler-zpa-connector.id}"
}

output "azurerm_resource_group_rg-zscaler-zpa-connector_name" {
  value = "${azurerm_resource_group.rg-zscaler-zpa-connector.name}"
}
